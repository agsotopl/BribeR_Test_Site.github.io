# Contributing to bribeR

This outlines how to propose a change to bribeR. For a detailed
...
of
Conduct](https://agsotopl.github.io/BribeR_Test_Site/CODE_OF_CONDUCT.md).
